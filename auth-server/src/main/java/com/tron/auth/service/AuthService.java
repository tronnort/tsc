...
public class AuthService {
    ...
    //用户认证申请令牌，将令牌存储到redis,该令牌是一个redis存储真实用户身份信息,权限信息的key. 之后需要使用用户信息时,通过该令牌向redis服务查询即可.
    ...
    public AuthToken getUserToken(String token){
        ...
        try {
            ...
            log.error("不能从redis服务器获取用户信息,错误信息:{}",e.getMessage());
            return null;
        }
